...
class BertTrainConfig:
    ...
    '''
    def __init__(self, num_train_epochs=3, learning_rate=5e-6, upper_dropout=0.1, max_seq_length=48, batch_size=1):
...
class BertClassifier:
    ...
    def __init__(self, pretrained_bert, num_labels, is_multi_label_rationales=False):
        '''
        ...
        self.is_multi_label_rationales = is_multi_label_rationales
    ...
    def train(self, pool_type, train_examples, train_labels, label_list, label2id, label_weights, train_token_label_ids=None, 
        ...
        if two_berts:
            self.model = TwoBertsForTextClassificationWithRationalesModel(self.pretrained_bert, pool_type=pool_type, num_text_labels=2, 
                ...
                is_multi_label_rationales=self.is_multi_label_rationales, learn_weights=learn_weights, shallow_fine_tuning=shallow_fine_tuning)
        ...
        # JOINT MODEL (ONE BERT)
            ...
            self.model = BertForTextClassificationWithRationalesModel.from_pretrained(self.pretrained_bert, \
                ...
                use_rationales=(rationale_weight>0), is_multi_label_rationales=self.is_multi_label_rationales, learn_weights=learn_weights, shallow_fine_tuning=shallow_fine_tuning)
        ...
        train_batch_size = batch_size # one text at a time (will be converted into a batch of sentences)
        ...
        for epoch in trange(int(train_config.num_train_epochs), desc="Epoch"):
            ...
            for step, instance in enumerate(train_examples):
                ...
                if text_weight > 0:
                    ...
                    # Added class weights
                    text_loss *= label_weights[train_labels[step]]
